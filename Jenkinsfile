node {
    ...
    stage('Testing') {
        ...
        dir ('sample-nodejs-service-tests') {
            ...
            sh "python3 loadtest.py 3000 2 ${BUILD_NUMBER} stagingloadtest.log SampleOnlineBankStaging"
    ...
    stage('WarmUpProduction') {
        ...
        dir ('sample-nodejs-service-tests') {
            ...
            sh "python3 loadtest.py 3010 2 ${BUILD_NUMBER} productionloadtest.log SampleOnlineBankProduction"
