node {
    ...
    stage('Testing') {
        ...
        dir ('sample-bank-app-service-tests') {
            ...
            sh "python3 smoke-test.py 3000 1 ${BUILD_NUMBER} stagingloadtest.log ${PUBLIC_IP} SampleOnlineBankStaging"
    ...
    stage('WarmUpProduction') {
        ...
        dir ('sample-bank-app-service-tests') {
            ...
            sh "python3 smoke-test.py 3010 1 ${BUILD_NUMBER} productionloadtest.log ${PUBLIC_IP} SampleOnlineBankProduction "
